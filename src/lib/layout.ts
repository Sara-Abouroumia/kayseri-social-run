...
export const siteMainClass = `${siteContainerClass} flex-1 py-10`;

/** Horizontal inset for dashboard header right column (matches nav link padding). */
export const dashboardHeaderInsetX = "px-2.5 sm:px-3";
